        ...
        if (getScale() == 1) {
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    onActionDown(event);
                    mTranslateX2 = event.getX();
                    mTranslateY2 = event.getY();
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    float juliy = 0f;
                    if (x > mTranslateX2) {
                        julix = x - mTranslateX2;
                    } else {
                        julix = mTranslateX2 - x;
                    }
                    if (y > mTranslateY2) {
                        juliy = y - mTranslateY2;
                    }else{

                    }
                    if (julix > juliy && event.getPointerCount() == 1) {
                            mScale = 1;
//                            Log.e(TAG, "如果不消费事件"+ julix+"/"+juliy);
                            return super.dispatchTouchEvent(event);
                    }

//                    //in viewpager
//                    if (mTranslateY == 0 && mTranslateX != 0) {
//                        Log.e(TAG, "如果不消费事件，则不作操作" + mTranslateY + "/" + mTranslateX);
//                        //如果不消费事件，则不作操作
//                        if (!isTouchEvent) {
//                            mScale = 1;
//                            return super.dispatchTouchEvent(event);
...
//                    }
                    ...
                    if (mTranslateY >= 0 && event.getPointerCount() == 1) {
                        onActionMove(event);
//                        Log.e(TAG, "dispatchTouchEvent: 梗啦=");
