package com.yunyouzhiyuan.qianbaoshangchengclient.network;
...
/**
 * Created by wangjunqiang on 2016/12/18.
 */
...
//                    BaseActivity topActivity = (BaseActivity) ActivityCollector.getTopActivity();
//                    topActivity.removeNetWorkView();
                } else {
//                        Log.e(TAG, "当前没有网络连接，请确保你已经打开网络 ");
//                    BaseActivity topActivity = (BaseActivity) ActivityCollector.getTopActivity();
//                    topActivity.addNetWorkView();
                }
