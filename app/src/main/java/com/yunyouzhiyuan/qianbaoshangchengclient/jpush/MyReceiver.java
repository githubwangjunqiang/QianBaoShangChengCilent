package com.yunyouzhiyuan.qianbaoshangchengclient.jpush;
...
import com.yunyouzhiyuan.qianbaoshangchengclient.activity.MainActivity;
...
import com.yunyouzhiyuan.qianbaoshangchengclient.util.SystemUtils;
...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            boolean appRunning = systemUtils.isAppRunning(context, currentProcessName);

            if (appRunning) {
                Intent intent1 = new Intent(context, DingDanActivity.class);
...
//                                myKey + " - " + json.optString(myKey) + "]");
                        if ("type".equals(myKey)) {
                            if (TextUtils.equals(Bean.JPush_Appkey, bundle.getString(JPushInterface.EXTRA_APP_KEY)) &&
                                    TextUtils.equals("VERIFY SUCESS", json.optString(myKey))) {
                                ConcreteSubject subject = ConcreteSubject.getInstance();
                                subject.nodifyDingdan();
                            }
                        }
                    }
